...
def make_multidose_arrays_1(idx1, idx2, type):
    #idx1-duplicate experiments, idx2-triplett experiments
    a1 = data19_1_M1[idx1,type]; a2 = data19_1_M1[idx1+1,type]
    a3 = data20_1_M1[idx1,type]; a4 = data20_1_M1[idx1+1,type]
    a5 = data21_2_M1[idx2,type]; a6 = data21_2_M1[idx2+1,type]; a7 = data21_2_M1[idx2+2,type]
    data = np.array([a1, a2, a3, a4, a5, a6, a7])
    return data

def make_multidose_arrays_2(idx1, idx2, type):
    #idx1 duplicate experiments, idx2 triplett experiments
    a1 = data19_2_M2[idx1,type]; a2 = data19_2_M2[idx1+1,type]
    a3 = data20_2_M2[idx1,type]; a4 = data20_2_M2[idx1+1,type]
    a5 = data21_1_M2[idx2,type]; a6 = data21_1_M2[idx2+1,type]; a7 = data21_1_M2[idx2+2,type]
    data = np.array([a1, a2, a3, a4, a5, a6, a7])
    return data
...
filename = str('WESTERN19_gel1.txt')
data19_1_M1 = extract_data(filename)
filename = str('WESTERN19_gel2.txt')
data19_2_M2 = extract_data(filename)

filename = str('WESTERN20_gel1.txt')
data20_1_M1 = extract_data(filename)
filename = str('WESTERN20_gel2.txt')
data20_2_M2 = extract_data(filename)

filename = str('WESTERN21_gel2.txt')
data21_2_M1 = extract_data(filename)
filename = str('WESTERN21_gel1.txt')
data21_1_M2 = extract_data(filename)
...
data_0gy_M1 = make_multidose_arrays_1(0, 0, norm_idx)
data_4gy_M1 = make_multidose_arrays_1(2, 3, norm_idx)
data_8gy_M1 = make_multidose_arrays_1(4, 6, norm_idx)
data_12gy_M1 = make_multidose_arrays_1(6, 9, norm_idx)
...
plot_mean_combined(doses_multi, data_0gy_M1, data_4gy_M1, data_8gy_M1, data_12gy_M1, SEM_M1, norm_idx, 'MOC1', 'blue')
plt.show()

#MOC2 norm_idx normalized refrence signal normalization of data
data_0gy_M2 = make_multidose_arrays_2(0, 0, norm_idx)
data_4gy_M2 = make_multidose_arrays_2(2, 3, norm_idx)
data_8gy_M2 = make_multidose_arrays_2(4, 6, norm_idx)
data_12gy_M2 = make_multidose_arrays_2(6, 9, norm_idx)
all_data_M2 = np.concatenate([data_0gy_M1, data_4gy_M1, data_8gy_M1, data_12gy_M1])

SEM_M2= SEM(data_0gy_M2, data_4gy_M2, data_8gy_M2, data_12gy_M2)
plot_mean_combined(doses_multi, data_0gy_M2, data_4gy_M2, data_8gy_M2, data_12gy_M2, SEM_M2, norm_idx, 'MOC2', 'red')
print_values(2)
plt.show()
"""
...
"""filename = str('WESTERN20_gel1_MAX.txt')
data20_1_M1_MAX = extract_data(filename)
filename = str('WESTERN20_gel2_MAX.txt')
data20_2_M2_MAX = extract_data(filename)
plot_seprate(data20_1_M1_MAX, 'MAX; MOC1, exp. 20', 2)
plot_seprate(data20_2_M2_MAX, 'MAX; MOC2, exp. 20', 2)

filename = str('WESTERN21_gel2_MAX.txt')
data21_2_M1_MAX = extract_data(filename)
filename = str('WESTERN21_gel1_MAX.txt')
data21_1_M2_MAX = extract_data(filename)
plot_seprate(data21_2_M1_MAX, 'MAX; MOC1, exp. 21', 3)
plot_seprate(data21_1_M2_MAX, 'MAX; MOC2, exp. 21', 3)
"""
